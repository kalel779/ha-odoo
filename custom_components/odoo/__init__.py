...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    activity_keyword = entry.options.get(CONF_ACTIVITY_KEYWORD, DEFAULT_ACTIVITY_KEYWORD)

    coordinator = OdooSalesCoordinator(
        hass, entry, client, amount_type, scan_interval, activity_keyword
    )
